...
@section('content')
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 订单管理 <span class="c-gray en">&gt;</span> 已评价<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    ...
    <table class="table table-border table-bordered table-bg">
        <thead>
        <tr>
            <th scope="col" colspan="15">已评价列表</th>
        </tr>
        <tr class="text-c">
            <th>订单编号</th>
            <th>订单名称</th>
        ...
        @foreach($data as $value)
            <tr class="text-c">
                ...
                <td>
                    ...
                    <a title="门店评论" href="javascript:;" onclick="store_reviews('门店评论','/admin/order/order/storeReviews','800','500','{{$value->id}}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe625;</i></a>
                    <a title="美发师评论" href="javascript:;" onclick="stylist_reviews('美发师评论','/admin/order/order/stylistReviews','800','500','{{$value->id}}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe60d;</i></a>
                </td>
            </tr>
        @endforeach
        </tbody>
...
<script type="text/javascript">
    ...
    /*订单-门店评论*/
    function store_reviews(title,url,w,h,id){
        layer_show(title,url+'?id='+id,w,h);
    }

    /*订单-美发师评论*/
    function stylist_reviews(title,url,w,h,id){
        layer_show(title,url+'?id='+id,w,h);
    }
</script>
@endsection