    ...
    <form class="form form-horizontal" id="form-user-update" method="post" action="">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                @else
                    <input type="text" class="input-text" name="name" value="{{$data[0]->name}}">
                @endif
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="package1" type="radio" value="1" id="package1-1" @if($data[0]->package1==1) checked @endif>
                    <label for="package1-1">是</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="package1-2" value="0" name="package1" @if($data[0]->package1==0) checked @endif>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="package2" type="radio" value="1" id="package2-1" @if($data[0]->package2==1) checked @endif>
                    <label for="package2-1">是</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="package2-2" value="0" name="package2" @if($data[0]->package2==0) checked @endif>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                @else
                    <textarea name="describe" class="textarea">{{$data[0]->describe}}</textarea>
                @endif
            </div>
        </div>
        <div class="row cl">
