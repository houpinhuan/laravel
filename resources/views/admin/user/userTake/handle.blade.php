...
@section('content')
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 提现管理 <span class="c-gray en">&gt;</span> 已处理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"><a href="javascript:;" onclick="location.href='/admin/user/userTake/finish'" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe644;</i> 导出已完成</a></div>
    <table class="table table-border table-bordered table-bg">
        <thead>
        <tr>
            <th scope="col" colspan="14">已处理</th>
        </tr>
        <tr class="text-c">
            <th>昵称</th>
            <th>真实名称</th>
        ...
        @foreach($data as $value)
            <tr class="text-c">
                ...
                <td>{{$value->amount}}</td>
                <td>{{$value->fee}}</td>
                <td>@if($value->status==0)已拒绝@else已完成@endif</td>
