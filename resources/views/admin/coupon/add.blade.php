    ...
    <form class="form form-horizontal" id="form-user-update" method="post" action="">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="type" type="radio" value="1" id="type-1" required>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" name="deduction" required>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>发放数量：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" name="quantity" required>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>有效期开始：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="validstart" id="validstart" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'%y-%M-%d',maxDate:'#F{$dp.$D(\'validend\')}'})" class="input-text Wdate" style="width:170px;" required>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>有效期结束：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="validend" id="validend" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'validstart\')||\'%y-%M-%d\'}'})" class="input-text Wdate" style="width:170px;" required>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>可使用时间开始：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="usestart" id="usestart" onfocus="WdatePicker({dateFmt:'HH:mm:ss'})" class="input-text Wdate" style="width:120px;">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>可使用时间结束：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="useend" id="useend" onfocus="WdatePicker({dateFmt:'HH:mm:ss'})" class="input-text Wdate" style="width:120px;">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>领取时间开始：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="receivestart" id="receivestart" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'%y-%M-%d',maxDate:'#F{$dp.$D(\'receiveend\')}'})" class="input-text Wdate" style="width:170px;" required>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>领取时间结束：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="receiveend" id="receiveend" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'receivestart\')||\'%y-%M-%d\'}'})" class="input-text Wdate" style="width:170px;" required>
            </div>
        </div>
        <div class="row cl">
